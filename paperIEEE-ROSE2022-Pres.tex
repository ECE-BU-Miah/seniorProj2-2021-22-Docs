...
\begin{frame}{Modeling Vehicle Subsystems}{System Requirements}
	...
	\begin{itemize}
    		...
    		\item Subsystem models must reach an accuracy level of at least 95\% 
...
\begin{frame}{Transfer Function Modeling}{Steering System Simulation}
	...
	\begin{itemize}
%			\item x-axis represents time in seconds 
			\item y-axis represents the steering angle in radians; range of -10 to 10
			\item Model was able to achieve a best fit percentage of 83.25\% 
...
%			\item x-axis represents time in seconds 
			\item y-axis represents the steering angle in radians; range of -10 to 10
			\item Model was able to achieve a best fit percentage of 86.87\% 
 		\end{itemize}
 		\begin{figure}
		    \centering
		    \includegraphics[width=0.4\textwidth]{figs/img/byWireSteeringTransferFunctionModel}
...
\begin{frame}{Transfer Function Modeling}{Acceleration System Simulation}
	\begin{block}{Manual Mode}
		\begin{itemize}
%			\item x-axis represents time in seconds 
			\item y-axis represents the acceleration pedal position as a percentage; range of -0.2 to 1.2 
			\item Model was able to achieve a best fit percentage of 98.3\% 
 		\end{itemize}
 		\begin{figure}
	    		\centering
...
%			\item x-axis represents time in seconds  
			\item  y-axis represents the acceleration pedal position as a percentage; range of -0.2 to 1.2 
			\item  Model was able to achieve a best fit percentage of 97.69\% 
 		\end{itemize}
		\begin{figure}
    			\centering
...
\begin{frame}{Neural Network Modeling}{Steering System Simulation}
	\begin{block}{}  		
  		\begin{figure}[H]
			...
			\item \begin{small} Only a few samples are just outside of the accuracy requirements \end{small}
			%\item \begin{small} Transfer function model did not meet the accuracy requirements \end{small} 
			\item \begin{small} y-axis of top graph represents the actual and desired steering angle in radians \end{small} 
...
\begin{frame}{Neural Network Modeling}{Acceleration System Simulation}
	\begin{block}{}
  		\begin{figure}[H]
			...
			\centering \begin{minipage}[b][0.4\textheight][c]{.45\linewidth}  \begin{itemize}
			\item \begin{small} All samples within 2\% of the actual output \end{small}
			\item \begin{small} y-axis of top graph represents the actual and desired acceleration pedal position as a percentage \end{small} 
			\item \begin{small} Fewer concerns about connections in Simulink \end{small} 
			\end{itemize} \end{minipage}\\[1em]
...
\begin{figure}[H]
			...
			\centering \begin{minipage}[b][0.4\textheight][c]{.45\linewidth}  \begin{itemize}
			\item \begin{small} With this model, the error is kept below 5\% \end{small} 
			\item \begin{small} y-axis of top graph represents the actual and desired brake pedal position as a percentage \end{small}
			\item \begin{small} Provides better results than the transfer function model \end{small} 
			\end{itemize} \end{minipage}\\[1em]
