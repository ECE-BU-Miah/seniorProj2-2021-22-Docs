...
\begin{frame}{Neural Network Modeling}{Steering System Simulation}
	\begin{block}{}  		
  		\begin{figure}[H]
			...
			\item \begin{small} y-axis of the top graphs represents the steering angle in radians \end{small} 
...
\begin{frame}{Neural Network Modeling}{Acceleration System Simulation}
	\begin{block}{}
  		\begin{figure}[H]
			...
			\item \begin{small} y-axis of the top graphs represents the acceleration pedal position as a percentage \end{small} 
...
\begin{figure}[H]
			...
			\item \begin{small} y-axis of the top graphs represents the brake pedal position as a percentage \end{small}
