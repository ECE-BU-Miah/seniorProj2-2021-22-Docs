...
\begin{frame}{Neural Network Modeling}{Brake System}
  \begin{block}{Modeling Process}
    		\begin{itemize}
    			\item Trained using data from the first brake log
    			\item Model tested with data from the second brake log
    		\end{itemize}
    		\begin{figure}[h]
...
\end{figure}
%    		\begin{figure}[H]
%    		\centering \includegraphics[width=.48\linewidth , height=.37\textheight]{figs/img/newBrakeSimulinkBlock.jpg}
%    		\end{figure}
  \end{block}
\end{frame}
