...
%  \todo[inline]{Where are the detailed simulink block diagram for each subsystem?}
	\begin{figure}
		\centering \includegraphics[width=.35\linewidth]{figs/img/steeringNeuralNetworkDetailedSystem}\quad%
		\caption{Steering Neural Network Simulink Model Subsystem}
		\centering \begin{minipage}[b][0.35\textheight][c]{.35\linewidth} 
%		\begin{itemize} \item HIL Bench 						
%		\item Measuring output voltages to confirm results \end{itemize} 
		\end{minipage}\\[1em]
		\centering \includegraphics[width=.35\linewidth]{figs/img/accelNeuralNetworkDetailedSystem}\quad%
		\caption{Acceleration Neural Network Simulink Model Subsystem}
		\centering \includegraphics[,width=.35\linewidth]{figs/img/brakeNeuralNetworkDetailedSystem}
		\caption{Brake Neural Network Simulink Model Subsystem}
	\end{figure}
\end{frame}

\begin{frame}{Validation and Testing}{Validation Setup}
	\begin{figure}
		\centering \includegraphics[width=.35\linewidth]{figs/img/picturesVisitToAStuff/hilBenchAstuff}\quad%
		\centering \begin{minipage}[b][0.35\textheight][c]{.35\linewidth} \begin{itemize} \item HIL Bench 						\item Measuring output voltages to confirm results \end{itemize} \end{minipage}\\[1em]
		\centering \includegraphics[angle=270,width=.35\linewidth]{figs/img/picturesVisitToAStuff/aStuffVisit2Nick}\quad%
		\centering \includegraphics[angle=270,width=.35\linewidth]{figs/img/picturesVisitToAStuff/hilMeasurementHannah}
	\end{figure}
\end{frame}
