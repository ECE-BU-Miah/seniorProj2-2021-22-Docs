...
At the beginning of the spring semester we will present the work we have completed so far to Dr. Miah and to representatives from AutonomouStuff. This is to let them see how the project is progressing and what our plans are for this semester. 
...
\begin{description}
\item[Collect shift, speed control, and speed data] $\ldots$
  
\item[Model shift system] $\ldots$
  
\item[Model speed control system] $\ldots$
\end{description}
