...
\begin{figure}
    \centering
    \captionsetup{justification=centering, margin=3cm}
    \includegraphics[width=5in]{figs/img/manualSteeringTransferFunctionModel}
