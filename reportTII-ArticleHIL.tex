...
of the acceleration subsystem.
 \begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % Connections
    \draw[stealth-,thick]
    (accelSubsystem.180)--node[pos=0.5,above]{Acceleration Pedal Voltages}++(-1.7,0);
    \draw[-stealth,thick]
    (accelSubsystem.0)--node[pos=0.5,above]{Acceleration Pedal Position}++(1.7,0);
 ...
 \begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % Connections
    \draw[stealth-,thick]
    (shiftSubsystem.180)--node[pos=0.5,above]{Desired Shifter Gear}++(-1.7,0);
    \draw[-stealth,thick]
    (shiftSubsystem.0)--node[pos=0.5,above]{Actual Shifter Gear}++(1.7,0);
...
This speed subsystem would fall under the multiple-input single-output system. There are four inputs, the position of the acceleration pedal and the brake pedal, along with the shifter actual gear. Taking these inputs, the speed subsystem finds the vehicle speed. This vehicle speed is the output of the system.  
 \begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % Connections
    \draw[stealth-,thick]
    (speedSubsystem.150)--node[pos=0.65,above]{Acceleration Pedal Position}++(-1.7,0);
    \draw[stealth-,thick]
    (speedSubsystem.180)--node[pos=0.65,above]{Brake Pedal Position}++(-1.7,0);
    \draw[stealth-,thick]
    (speedSubsystem.-150)--node[pos=0.65,above]{Shifter Gear}++(-1.7,0);
    \draw[-stealth,thick]
    (speedSubsystem.0)--node[pos=0.5,above]{Vehicle Speed}++(1.7,0);
...
\end{figure}
 ...
 \begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % Connections
    \draw[stealth-,thick]
    (speedControlSubsystem.180)--node[pos=0.5,above]{Desired Vehicle Speed}++(-1.7,0);
    \draw[-stealth,thick]
    (speedControlSubsystem.0)--node[pos=0.5,above]{Actual Vehicle Speed}++(1.7,0);
