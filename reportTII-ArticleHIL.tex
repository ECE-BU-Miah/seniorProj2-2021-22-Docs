...
\todo[inline]{Need annotation of each of the pictures. Like that, we show what
  each of the equipment are}
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.48\linewidth}
		\centering    		
