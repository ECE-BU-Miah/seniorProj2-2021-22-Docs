...
\end{figure}
 ...
 \section{Modeling Dynamic System using Neural Network}
 ...
 that .......
 The main structure of a neural network consists neurons, input layer of
 ...
 The actual network of a nural network following parallel and distributed system
 architecture. .....


 \missingfigure{Add a generic picture/block diagram of a multiple-input multiple output
   dynamic system}
 \todo[inline]{Add a generic picture of a neural network}
...
On October 7th we traveled to AutonomouStuff in order to collect
data from the steering, acceleration, and braking subsystems in an autonomous
vehicle. The data we collected will be used to generate and then verify our
...
\todo[inline]{Discuss pros and cons of the results you presented in the previous sections on each of the techniques you incorporated}
...
\todo[inline]{One paragraph on conclusion, make sure you to recommend what modeling technique for the company }
\todo[inline]{One paragraph on future work}
