...
\title[HIL Plant Modeling]{Hardware-in-Loop Plant Modeling for Autonomous
  Vehicle}
...
\linebreak Advisors:~Dr.~Suruz~Miah}
...
\begin{frame}{Problem Statement}
 ...
 \begin{itemize}
  ...
  \begin{block}{Proposed Solution}
    \begin{large}
      Use conventional System Identification techniques for modeling subsystems based on available raw data.  
    \end{large}
  \end{block}
\end{frame}
...
\begin{frame}{Literature Review}
  \begin{block}{Existing Solution}
        Use of System Identification Toolbox in Matlab to create models from data~\cite{Donjaroennon2021}
  \end{block}
  \begin{block}{Existing Solution}
        Third order ARMAX model creates models using traditional methods of analysis~\cite{Li1999}
  \end{block}
  \begin{block}{Existing Solution}
        Steer-By-Wire method as a system model~\cite{Saruchi2015}
  \end{block}
    % \begin{figure}[b]
    %     \centering
