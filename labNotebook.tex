...
% Place your initial below
HG\\
During the lab time I worked on making the font for the inputs and outputs of the steering, brake, and speed model block diagrams. The acceleration, shift, and speed control model block diagrams didn't show up when I opened them in Inkscape. 
